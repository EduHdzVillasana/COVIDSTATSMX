...
graph_size = (5, 5)
R0 = 1.5
p_contacto = 0.1 #probabilidad promedio de contagio dentro del radio (0 < p_contacto <= 1)
...
def estimar_radio(R0, n, l, pr, p_contacto=0.5):
    ...
    T_inf = 1 / pr                    # duración promedio de la infección
...
def contagio(X,Y, estado, l, r, pr):
    ...
    return contagios
# %%
def mover_y_actualizar(estado, agentes, contagios, l, pr, tiempo):
